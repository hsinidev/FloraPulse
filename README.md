...
> Modern, high-performance Android application for FloraPulse.

**Indoor Plants / AI Diagnosis** built with Kotlin and modern Android development standards.
...
- **Core Functionality**: Streamlined tools and workflows for FloraPulse.
